...
const Header = () => {
  return (
    <div className='sh__header'>
          ...
          <div className='sh__header-content-apps'>
            <div className='sh__header-content-apps-apple'>
              <motion.button
                ...
                type='button'><a href='https://apps.apple.com/us/app/shoof-global/id1496447376' target='_blank'><FaApple className='sh__header-content-apps-icons' />App Store</a></motion.button>
            </div>
            ...
            type='button'><a href='https://play.google.com/store/apps/details?id=io.shoof' target='_blank'><FaGooglePlay className='sh__header-content-apps-icons'/>Play Store</a></motion.button>
      ...
      <div className='sh_header-title' id='products'>
          <h1>
